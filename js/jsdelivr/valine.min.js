    ...
    return function(e) {
        ...
        */
        ...
        var a = n(26),
            ...
            j = "",
            T = {
                cdn: "https://avatar.lolicon.team/avatar/",
        ...
        o.prototype.Q = function(e) {
            ...
            var C = function(t, n, r) {
                    ...
                    var l = t.get("link") ? /^https?\:\/\//.test(t.get("link")) ? t.get("link") : "http://" + t.get("link") : "",
                        ...
                        u = T.hide ? "" : e.config.enableQQ && t.get("QQAvatar") ? '<img class="vimg" src="' + t.get("QQAvatar") + '" referrerPolicy="no-referrer"/>' : '<img class="tool-pendant"src="https://images.2w2.top/user/avatar/20.webp"/><img class="vimg" src="' + (T.cdn + (0, s.default)(t.get("mail")) + T.params) + '">',
